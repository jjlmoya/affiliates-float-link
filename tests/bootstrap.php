<?php
/**
 * Affiliates_Float_Link Test Bootstrapper.
 *
 * @since   0.0.0
 ...
 * @since 0.0.0
 */
function _manually_load_affiliates_float_link_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/affiliates-float-link.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_affiliates_float_link_plugin' );
